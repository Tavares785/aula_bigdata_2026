...
def word_count_rdd(sc, lines):
    ...
    return contagens.sortBy(lambda kv: (-kv[1], kv[0])).collect()
...
def main():
    ...
    # Workaround Glue: o committer padrao da API antiga (DirectOutputCommitter)
    # nao existe no runtime; usa o FileOutputCommitter do Hadoop no saveAsTextFile.
